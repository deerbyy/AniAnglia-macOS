...
- Release detail page with poster zoom, metadata, genres, expandable description, searchable/filterable episodes, screenshots, related collections, video blocks, comments with expandable replies, clickable comment authors, own-comment editing/deletion, and bookmark actions.
