...
- Catalog filters with quick presets, active-filter chips, reset/apply controls, result counts, and context-menu library actions; public collections browser with search, Anixart sort modes, collection detail pages, searchable release lists, clickable collection authors, and account-synced favorite collections.
